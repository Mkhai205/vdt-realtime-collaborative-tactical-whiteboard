...
export function buildGuestRestHeaders(identity: GuestIdentity): GuestRestHeaders {
    return {
...
export function buildGuestSocketAuth(identity: GuestIdentity): SocketAuthPayload {
    return {
        guestId: identity.id,
