...
/**
 * Renders a single POLYGON board object as a Konva closed Line.
 * Selection highlight is handled by the Konva Transformer in SelectionLayer.
 */
export const PolygonObject = memo(function PolygonObject({
  object,
  isSelected,
  editingUser,
  onSelect,
  ...
  const s = resolveStyle("POLYGON", object.style)
