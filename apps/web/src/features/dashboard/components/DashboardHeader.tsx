    ...
    <header className="sticky top-0 z-40 w-full border-b backdrop-blur-md">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2">
          <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-violet-600 shadow-sm shadow-violet-500/20">
            <Paintbrush className="h-5 w-5 text-white" />
          </div>
          <div className="flex flex-col">
            <span className="text-lg font-bold tracking-tight">Whiteboard</span>
        ...
        <div className="flex items-center gap-3">
          <div ref={dropdownRef} className="relative">
            <button
              ...
              className="flex cursor-pointer items-center gap-1.5 rounded-full p-1 transition-colors hover:bg-accent focus:outline-none"
            >
            ...
            {/* Dropdown Popover */}
            {dropdownOpen && (
              <div className="absolute right-0 z-50 mt-2 w-56 origin-top-right rounded-xl bg-card p-1 shadow-lg">
                {/* User Info */}
                ...
                {/* Dropdown Items */}
                <div className="py-1">
                  <div className="dark: flex w-full items-center gap-2 px-3 py-2 font-semibold select-none">
